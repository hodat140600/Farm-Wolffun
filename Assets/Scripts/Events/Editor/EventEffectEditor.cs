...
namespace Farm.Events.EditorTool
{
    ...
    public class EventEffectEditor : Editor
    {
        ...
        public override void OnInspectorGUI()
        {
            ...
            if (myScript.type == NarrativeEffectType.AddWorkerAttribute || myScript.type == NarrativeEffectType.SetWorkerAttribute)
            {
                myScript.value_data = AddScriptableObjectField<WorkerData>("Target", myScript.value_data);
