...
namespace Farm
{
    ...
    public class TheControls : MonoBehaviour
    {
        ...
        void Update()
        {
            ...
            //Selection
            bool worker_selected = Selectable.IsWorkerSelected();
            bool order_click = TheGame.IsMobile() && worker_selected;
            ...
            //Give order (right click or left click mobile with worker selected)
