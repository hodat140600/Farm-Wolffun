...
{
    /// <summary>
    /// Manages stats that are global to the Worker Area (instead of for individual characters
    /// </summary>

    public class WorkerAreaManager : MonoBehaviour
    {
        [Header("Attributes")]
        public AttributeData[] attributes;  //List of available GLOBAL attributes (one generic value, not per character)


        private static WorkerAreaManager instance;
        ...
        public static WorkerAreaManager Get()
        {
            return instance;
        }
    }
