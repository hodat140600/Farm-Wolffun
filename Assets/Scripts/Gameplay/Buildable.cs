...
namespace FarmWolffun
{
    ...
    public class Buildable : MonoBehaviour
    {
        ...
        public bool build_obstacle_trigger = true; //If true, colliders that are set to IsTrigger will also be obstacles when building
        ...
        public bool CheckIfOverlap()
        {
            ...
            {
                QueryTriggerInteraction trigger = build_obstacle_trigger ? QueryTriggerInteraction.Collide : QueryTriggerInteraction.Ignore;
