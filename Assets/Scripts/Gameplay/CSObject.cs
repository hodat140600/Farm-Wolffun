...
{
    /// <summary>
    /// A generic Farm class that includes items, worker, buildings, NPCs and spawnables
    ...
    public abstract class CSObject : MonoBehaviour
    {
        ...
        public static GameObject Create(CSData data, Vector3 pos)
        {
            ...
            if (data is WorkerData)
            {
                WorkerData item = (WorkerData)data;
                Worker obj = Worker.Create(item, pos);
                return obj.gameObject;
            }
